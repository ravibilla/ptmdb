...
DROP PROCEDURE IF EXISTS spGetFrontendEISDataByLot;

DELIMITER //

-- Create a procedure to get all Frontend EIS Test Data by Lot
CREATE PROCEDURE spGetFrontendEISDataByLot(
    IN p_Lot VARCHAR(16)
)
BEGIN
...
-- Test
CALL  spGetFrontendEISDataByLot ('C228-1-');