...
IF OBJECT_ID('[dbo].spGetBackendEISDataByLot', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].spGetBackendEISDataByLot;
GO

-- Stored procedure to get Backend EIS Tsst Data at all frequencies by Lot
CREATE PROCEDURE spGetBackendEISDataByLot
@Lot Nvarchar(16)
AS
BEGIN
    BEGIN TRY
...
-- Test
EXECUTE  spGetBackendEISDataByLot 'C228-1-'
